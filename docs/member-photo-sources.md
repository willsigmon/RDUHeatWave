...
| Member | Reason not added yet |
| --- | --- |
| David Mercado | Verified current William Douglas / CAI / LinkedIn identity, but no clean public headshot source was found. Search results mostly show William Douglas graphics, unrelated namesakes, or private/third-party profile pages. |
| Nathan Senn | Found an exact-name Facebook profile image, but it is not tied to Franco Restorations in public page metadata, so it is not safe enough to publish as a member headshot without confirmation. |
